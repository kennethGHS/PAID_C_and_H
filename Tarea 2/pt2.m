 function pt2
   W = [0.151,0.554,0.989];
  [ZerosCD,ZerosImag,ZerosReal,CompressedImaginary,CompressedReal,CompressedCD,PossibleValuesReal,PossibleValuesImag] = compress_image("elena.jpg", 30,W);
  m = escale((CompressedReal),255)
   Image = (abs((reverse_compression(ZerosCD,ZerosImag,ZerosReal,CompressedImaginary,CompressedReal,CompressedCD,PossibleValuesReal,PossibleValuesImag,W,20,20,30))));
   imwrite(uint8(floor(Image)),"Result30.jpg");
   W = [0.151,0.554,0.989];
  [ZerosCD,ZerosImag,ZerosReal,CompressedImaginary,CompressedReal,CompressedCD,PossibleValuesReal,PossibleValuesImag] = compress_image("elena.jpg", 20,W);
   Image = (abs((reverse_compression(ZerosCD,ZerosImag,ZerosReal,CompressedImaginary,CompressedReal,CompressedCD,PossibleValuesReal,PossibleValuesImag,W,20,20,20))));
   imwrite(uint8(floor(Image)),"Result20.jpg");
   W = [0.151,0.554,0.989];
  [ZerosCD,ZerosImag,ZerosReal,CompressedImaginary,CompressedReal,CompressedCD,PossibleValuesReal,PossibleValuesImag] = compress_image("elena.jpg", 40,W);
   Image = (abs((reverse_compression(ZerosCD,ZerosImag,ZerosReal,CompressedImaginary,CompressedReal,CompressedCD,PossibleValuesReal,PossibleValuesImag,W,20,20,40))));
  ...
  [ZerosCD,ZerosImag,ZerosReal,CompressedImaginary,CompressedReal,CompressedCD,PossibleValuesReal,PossibleValuesImag] = compress_image("elena.jpg", 60,W);
   Image = (abs((reverse_compression(ZerosCD,ZerosImag,ZerosReal,CompressedImaginary,CompressedReal,CompressedCD,PossibleValuesReal,PossibleValuesImag,W,20,20,60))));
  ...
  [ZerosCD,ZerosImag,ZerosReal,CompressedImaginary,CompressedReal,CompressedCD,PossibleValuesReal,PossibleValuesImag] = compress_image("elena.jpg", 70,W);
   Image = (abs((reverse_compression(ZerosCD,ZerosImag,ZerosReal,CompressedImaginary,CompressedReal,CompressedCD,PossibleValuesReal,PossibleValuesImag,W,20,20,70))));
