 function pt2
  ...
  [ZerosCD,ZerosImag,ZerosReal,CompressedImaginary,CompressedReal,CompressedCD,PossibleValuesReal,PossibleValuesImag] = compress_image("elena.jpg", 30,W);
   Image = (abs((reverse_compression(ZerosCD,ZerosImag,ZerosReal,CompressedImaginary,CompressedReal,CompressedCD,PossibleValuesReal,PossibleValuesImag,W,256,256,30))));
  ...
  [ZerosCD,ZerosImag,ZerosReal,CompressedImaginary,CompressedReal,CompressedCD,PossibleValuesReal,PossibleValuesImag] = compress_image("elena.jpg", 20,W);
   Image = (abs((reverse_compression(ZerosCD,ZerosImag,ZerosReal,CompressedImaginary,CompressedReal,CompressedCD,PossibleValuesReal,PossibleValuesImag,W,256,256,20))));
